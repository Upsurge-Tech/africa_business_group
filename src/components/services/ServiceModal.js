...
const img1 = "/images/services/img1.png";
const img2 = "/images/services/img2.png";
const img3 = "/images/services/img3.png";


const ServiceModal = ({onClose}) => {
  return (
    <div className="fixed bg-black bg-opacity-60 top-0 left-0 right-0 bottom-0 z-50 flex justify-center items-center">
      <div className="lg:w-[950px] xs:w-full sm:w-[450px] max-w-full lg:h-[700px] h-[600px] bg-white rounded-xl p-4 flex flex-col relative">
        <div className="flex justify-end cursor-pointer">
          <AiOutlineClose size={30} onClick={onClose} />
        </div>
        <div className="lg:flex lg:placeholder:flex-col justify-between my-2 gap-x-10 hidden">
          <div className="w-[400px] h-[300px] basis-1/2">
            <img src={img1} alt="img1" className="w-full" />
          </div>
          <div className="flex flex-col lg:gap-y-20 basis-1/2 lg:mt-[-20px]">
        ...
        <div className="mt-[5px]">
          <h1 className="text-start text-[20px] lg:text-[30px] font-bold">
            Export and distribution of industrial and construction minerals
          </h1>
          <p className="lg:text-[13px] text-[11px] text-start">
            At Innovest Africa Business Group, we take immense pride in our
            ...
            and reliability sets us apart as a trusted partner in this sector.
          </p>
        </div>
